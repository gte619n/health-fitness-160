...
class NutritionServiceTest {
    ...
    void logDay_persistsTheDay_andIsReadable() {
        ...
        NutritionService svc = new NutritionService(repo, capturingPublisher(new ArrayList<>()));

        LocalDate date = LocalDate.of(2026, 5, 20);
        svc.logDay(USER, date, 150.0, 200.0, 60.0, 2000.0);
    ...
    void logDay_upsertsSameDate_ratherThanDuplicating() {
        ...
        LocalDate date = LocalDate.of(2026, 5, 20);
        svc.logDay(USER, date, 150.0, 200.0, 60.0, null);
        svc.logDay(USER, date, 180.0, 210.0, 70.0, null);
    ...
    void logDay_publishesAllFourNutritionMetrics() {
        ...
        NutritionService svc = new NutritionService(repo, capturingPublisher(events));

        svc.logDay(USER, LocalDate.of(2026, 5, 20), 150.0, 200.0, 60.0, 2000.0);
